        ...
        IDENTIFIER '(' ')' ';'
{
        if(predefined.find($1) == NULL){
                ...
                //I don't think we need to check anything
                $$ = new Funcall_Astnode(new Identifier_Astnode($1));
        ...
        | postfix_expression '[' expression ']'
{
        ...
        else if($1->data_type.star != 0)
        {
                $$ = new Arrayref_Astnode($1, $3);
        //        $$->data_type = $1->data_type;  
        //        $$->data_type.star--; // should be changed
        ...
        | postfix_expression PTR_OP IDENTIFIER
{
        if($1->data_type.ref){
                ...
                //{
                //        cout<<"Error at postfix ptr in line "<<line<<": no sturct found\n";
                //        exit(1);
                //}
//
                //SymbTab* local = gst.find(base)->symtab;
                ...
                //if(local->find($3) == NULL)
                //{
                //        cout<<"Error at postfix ptr: \""<<base<<"\" has no member \""<<$3<<"\"\n";
                //}
